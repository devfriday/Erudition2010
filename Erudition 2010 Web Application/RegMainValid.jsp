...
<div id="templatemo_menu_wrapper">
	...
	<div id="templatemo_menu"><br />
	  <h1 style="color:#000">ERUDITION Registeration Validity</h1></div> <!-- end of menu -->
...
<div id="templatemo_content">
 ...
 <div id="main_column">
                ...
                String uid1=request.getParameter("t2");
                String college1=request.getParameter("t5");
                String branch1=request.getParameter("t6");
                String email1=request.getParameter("t7");
                ...
                java.sql.ResultSet rs=stm.executeQuery("select * from Erudition.main where Email='"+email1+"';");
                if(rs.next())
                {	%>
				...
				<table width="858" border="0" >
                    ...
                    <tr>
                    <td>
		<p>An ERROR occured while Registering for ERUDITION.<br/>You have already Registered for ERUIDITION.<br />Please return to <a href="MainRegFrm.html">Main Registeration Form</a> and register with another Email ID...</p>
                     </td>
                     <td valign="top">
                ...
                int a=0,b=0;
                            a=stm.executeUpdate("insert into Erudition.main(Name,Username,College,Branch,Email,Mobile) values('"+name1+"','"+uid1+"','"+college1+"','"+branch1+"','"+email1+"','"+mob+"');");

		            if(a!=0)
                     {
                    rs=stm.executeQuery("select max(RegID) from Erudition.main");
                    if(rs.next()){reg=rs.getInt(1);
                     b= stm.executeUpdate("insert into Erudition.authentication values('"+uid1+"',"+reg+",'"+data+"');");
                    ...
                    <td width="256">
                     ...
                     <td width="244" valign="top">
                      <%out.print("<span id=\"s1\">"+reg+"</span>");%><br/><span style="color:silver ">REMEMBER THIS!!!<br />This will be used for Event Registeration</span>
                    </td><td width="344" align="right"><h1 >Competitons</h1></td></tr>
                    <tr>
                    ...
                    <td>
                     <h2>User ID</h2></td>
                     <td valign="top">
                      <span id="s2"> <% out.print(uid1); %></span>
                    </td><td align="right"><a href="matlab.html" style=" font-size:12px">Mat-Lab</a><br />
                    <a href="ingeneious.html" style=" font-size:12px">Ingenious</a><br />
                    <a href="popsicle.html" style=" font-size:12px">Fragilogistics</a></td></tr>
                    <tr>
                    <td>
                     <h2>College</h2></td>
                     <td valign="top">
                      <span id="s3"> <% out.print(college1); %></span>
                    </td><td align="right"><a href="conjura.html" style=" font-size:12px">Conjura (Open Software Exhibition)</a><br />
                    <a href="genesis.html" style=" font-size:12px">Genesis (Open Hardware Exhibition)</a><br />
                    <a href="paperpresentation.html" style=" font-size:12px">Xperia (Paper Presentation)</a></td></tr>
                    <tr>
                    <td>
                     <h2>Branch</h2></td>
                     <td valign="top">
                      <span id="s4"> <% out.print(branch1); %></span>
                    </td><td align="right"><a href="vhdl.html" style=" font-size:12px">VHDL (Workshop)</a><br />
                    <a href="ham.html" style=" font-size:12px">HAM Radio (WorkShop)</a><br />
                    <a href="#" style=" font-size:12px">AutoCad (WorkShop)</a></td></tr>
                    <tr>
                    <td>
                     <h2>Email ID</h2></td>
                     <td valign="top">
                      <span id="s5"> <% out.print(email1); %></span>
                    </td><td align="right"><a href="information.html" style=" font-size:12px">Information Security (WorkShop)</a><br />
                    <a href="nfs.html" style=" font-size:12px">NFS Most Wanted (LAN Gaming)</a><br />
                    <a href="counterstrike.html" style=" font-size:12px">Counter Strike (LAN Gaming)</a></td></tr>
                    <tr>
                    <td valign="top">
                     <h2>Mobile No.</h2></td>
                     <td valign="top">
                      <span> <% out.print(mob); %></span>
                    </td><td align="right"><a href="vlsi.html" style=" font-size:12px">VLSI (Leacture)</a><br />
                    <a href="ni.html" style=" font-size:12px">NI (Workshop)</a><br />
                   <a href="robowars.html" style=" font-size:12px">RoboWars (Robotics)</a><br />
                   <a href="backwash.html" style=" font-size:12px">BackWash (Robotics)</a><br />
                    ...
                    <tr><td width="520"><p style="color:orange">Thank You for Registering in ERUDITION GGITM TechFest<br />Please use the generated Registeration ID to Register for Events</p>
                    </td>
                      <td width="344" align="right"> <a href="onspot.html" style=" font-size:12px">On Spot Designing (Avocation)</a><br />
                    <a href="astroquiz.html" style=" font-size:12px">Astronomy Quiz (Youth Academician)</a><br />
                    <a href="transportation.html" style=" font-size:12px">Transportation Problem (Youth Academician)</a><br />
                    <a href="techquiz.html" style=" font-size:12px">Tech Quiz (Youth Academician)</a><br />
                    <a href="prdc.html" style=" font-size:12px">PRDC (Workshop)</a><br />
		...
		else
		{
		 ...
		 %>
                ...
                <% }  }}catch(Exception e){System.out.println(e);%>
                    ...
                    <tr>
                    <td width="520">
                        <h2 style="color:red">ERROR:<%out.println("<p>"+e+"</p>");%></h2>
                     </td>
                     <td width="0" valign="top">
                    ...
                    <tr>
                    <td>
                        <p>Sorry, an error has occured while connection with server<br />Please <a href="MainRegFrm.html">REGISTER</a> again after sometime</p>
                     </td>
                     <td valign="top">
