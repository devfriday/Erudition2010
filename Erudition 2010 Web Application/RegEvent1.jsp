...
<%
                ...
                con=java.sql.DriverManager.getConnection("jdbc:mysql://localhost:3306/Erudition","root","");con.setAutoCommit(false);
                java.sql.Statement stm=con.createStatement();
                 int i1=0,i11=0;

                 rs=stm.executeQuery("select RegID1 from Erudition."+eventname+" where RegID1="+r1+";");
                if(rs.next())
                {
                    i1=1;
                }
				...
				<table width="858" border="0" >
                    ...
                    <tr>
                    <td>
		<p>An ERROR occured while Registering for Event.<br/>You have already Registered for Event.<br />Please return to <a href="Event4.html">Event Registeration Form</a> and register with another RegID...</p>
                     </td>
                     <td valign="top">
                ...
                <%
                 ...
                 if(rs.next())
                     ...
                     if(rs.getString(1).compareTo(r2)!=0)
                         {
                         msg="<br><br>Wrong Password corrosponding to RegID: "+r1+" ";
                         throw new Exception();
                         }
                     }
                    String name1=null;
                    ...
                    if(rs.next())
                    {
                        name1=rs.getString(1);
                                  ...
                                  int x=stm.executeUpdate("insert into "+eventname+"(Name1,RegID1) values('"+name1+"',"+r1+");");
                                  if(x==1)
                            {
                            int eid=0;
                    ...
                    <a href="popsicle.html" style=" font-size:12px">Fragilogistics</a></td></tr>
                    <tr>
                    <td width="520"><p style="color:orange">Thank You for Registering in Event <br />Please remember the generated Event ID</p>
                     </td>
                     <td></td>
                     <td align="right"><a href="conjura.html" style=" font-size:12px">Conjura (Open Software Exhibition)</a><br />
                    <a href="genesis.html" style=" font-size:12px">Genesis (Open Hardware Exhibition)</a><br />
                    <a href="paperpresentation.html" style=" font-size:12px">Xperia (Paper Presentation)</a></td></tr>
                    <tr>
                    <td>
		...
		else
		{
		 ...
		 %>
                ...
                <% }  }catch(Exception e){%>
                    ...
                    <a href="techcoders.html" style=" font-size:12px">TechCoders</a></td></tr>
                    <tr>
                    <td><p>Sorry, an error has occured while connection with server<br />Please <a href="Event1.html">REGISTER</a> again</p>
                     </td>
                     <td valign="top">
                      <br />
                    </td><td align="right"><a href="matlab.html" style=" font-size:12px">Mat-Lab</a><br />
