...
<div id="templatemo_content">
 ...
 <div id="main_column">
    ...
    <div class="section_w560">
      <ul class="list_01">
    <br/><h1>Administrator</h1>
      </ul><p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>

      <form name="f1" action="Query.jsp" action="post"><table border="0"><tr><td width="233">
      <h2>Admin Name</h2></td><td width="233" valign="top"><input type="text" name="t1" id="t1" size="40"></td></tr>

  <tr><td>    <h2>Password</h2></td><td valign="top"><input type="password" name="t2" id="t2" size="40"></td></tr>
  <tr><td><input type="submit" name="b1" value="Login" size="50"></td><td>
<%
String str=(String)request.getParameter("msg");
if(str!=null)out.print("<h3 style=\"color:red\">"+str+"</h3>");
%></td></tr></table>
      </form>
  <p>&nbsp;</p>
  <br />
