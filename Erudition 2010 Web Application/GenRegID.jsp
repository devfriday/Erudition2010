...
<title>Generated Registeration ID</title>
...
<div id="templatemo_menu_wrapper">
	...
	<div id="templatemo_menu">
	  <h1 style="color:#000">Generated Registeration ID</h1></div> <!-- end of menu -->
...
<%
                ...
                String r1=request.getParameter("t1");String r2=request.getParameter("t2");
                try{
                Class.forName("com.mysql.jdbc.Driver");
                con=java.sql.DriverManager.getConnection("jdbc:mysql://localhost:3306/Erudition","root","");
                java.sql.Statement stm=con.createStatement();
                java.sql.ResultSet rs=stm.executeQuery("select Password from Erudition.authentication where Username='"+r1+"';");
                if(rs.next())
                    {
                    if(rs.getString(1).compareTo(r2)!=0)
                        {
                        msg="Incorrect Password corrosponding to UserID: "+r1+"\n";
                        throw new Exception();
                        }
                    }
                else
                    {
                    msg="UserID: "+r1+" does not Exist\n";
                    throw new Exception();
                    }
                 rs=stm.executeQuery("select RegID from Erudition.authentication where Username='"+r1+"';");
                if(rs.next())
                {
				...
				<table width="858" border="0" >
                    ...
                    <tr>
                    <td width="520">
                     <h2 style="color:orange">Registeration ID</h2></td>
                     <td width="0" valign="top">
                    </td><td width="344" align="right"><h1 >Competitons</h1></td></tr>
                    <tr>
                    <td>
		 <h2>UserID... <%out.print(r1);%></h2>
                     </td>
                     <td valign="top">
                    ...
                    <tr>
                    <td> <h2>RegID... <%out.print(rs.getString(1));%></h2></td>
                     <td valign="top">
                    ...
                    <a href="#" style=" font-size:12px">VLSI Embedded (WorkShop)</a></td></tr>
                    <tr>
                    <td>
                     </td>
                     <td valign="top">
                ...
                <%
                    ...
                    <td width="520" valign="top">
                     <p><a style=" color:red ; font-size:32px">SORRY...</a><br />No record has been found corrosponding to this Email ID<br />
                     Please return to <a href="MainRegFrm.html">Registeration Form...</a>to register again</p></td>
                     <td width="0" valign="top">
                   ...
                   <a href="backwash.html" style=" font-size:12px">BackWash (Robotics)</a><br />
                    ...
                    <a href="astroquiz.html" style=" font-size:12px">Astronomy Quiz (Youth Academician)</a><br />
                    <a href="transportation.html" style=" font-size:12px">Transportation Problem (Youth Academician)</a><br />
                    <a href="techquiz.html" style=" font-size:12px">Tech Quiz (Youth Academician)</a><br /></td>
                    <a href="prdc.html" style=" font-size:12px">PRDC (Workshop)</a><br />
                   </tr></table> <%
                      }
		 ...
		 %>
                ...
                <%  }catch(Exception e){%>
                    ...
                    <tr>
                    <td width="520">
                        <h2 style="color:red"><strong>ERROR:</strong><%out.println(" "+msg+"<br/><p>"+e+"</p>");%></h2>
                     </td>
                     <td width="0" valign="top">
                    ...
                    <tr>
                    <td>
                        <p>Sorry, an error has occured while connection with server<br />Please REGISTER again after sometime</p>
                     </td>
                     <td valign="top">
