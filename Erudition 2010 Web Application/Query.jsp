...
<div id="templatemo_content">
 ...
 <div id="main_column">
    ...
    <div class="section_w560">
      <ul class="list_01"><h1>Administrator</h1>
         <script language="javascript">
             function openTab()
             {
                 window.open("Table.jsp");
             }
    </script>
          <%
          java.sql.Connection con=null;
                ...
                java.sql.ResultSet rs=stm.executeQuery("select user,pass from Erudition.admin;");
                if(rs.next())
                {
                    if(rs.getString(1).compareToIgnoreCase(name1)==0)
                        {
                        if(rs.getString(2).compareTo(pass)==0)
                      ...
                      else
                          {
                             request.setAttribute("err","Invalid Password...");
                                %>
                                 <jsp:forward  page="Admin.jsp"  >
                                  <jsp:param name="msg" value="Invalid Password..." />
                                      </jsp:forward>
                                <%
                            ...
                            {
                              request.setAttribute("err","Invalid Admin Name...");
                                %>
                                 <jsp:forward  page="Admin.jsp"  >
                                      <jsp:param name="msg" value="Invalid Admin Name..." />
                                      </jsp:forward>
                ...
                request.setAttribute("err","Error in connection with Server");
