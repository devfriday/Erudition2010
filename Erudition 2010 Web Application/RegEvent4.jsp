...
<%
				java.sql.Connection con=null;String msg="";int i11=0,i22=0,i33=0,i44=0;
                ...
                String r4=request.getParameter("t4");
                 String r11=request.getParameter("t11");
                  String r22=request.getParameter("t22");
                   String r33=request.getParameter("t33");
                    String r44=request.getParameter("t44");
                try{
                ...
                java.sql.Statement stm=con.createStatement();
                 ...
                 java.sql.ResultSet rs=stm.executeQuery("select RegID1 from Erudition."+eventname+" where RegID1="+r1+" or RegID1="+r2+" or RegID1="+r3+" or RegID1="+r4+";");
                if(rs.next())
                {
                    i1=1;
                }
                  rs=stm.executeQuery("select RegID2 from Erudition."+eventname+" where RegID2="+r1+" or RegID2="+r2+" or RegID2="+r3+" or RegID2="+r4+";");
                if(rs.next())
                {
                    i2=1;
                }
                   rs=stm.executeQuery("select RegID3 from Erudition."+eventname+" where RegID3="+r1+" or RegID3="+r2+" or RegID3="+r3+" or RegID3="+r4+";");
                if(rs.next())
                {
                    i3=1;
                }
                    rs=stm.executeQuery("select RegID4 from Erudition."+eventname+" where RegID4="+r1+" or RegID4="+r2+" or RegID4="+r3+" or RegID4="+r4+";");
                if(rs.next())
                {
                    i4=1;
                }
		...
		<p>An ERROR occured while Registering for Event.<br/>Some have already Registered for Event.<br />Please return to <a href="Event4.html">Event Registeration Form</a> and register with another RegID...</p>
                    ...
                    <td><p><% if(i3==1)
                        {
                        out.print("RegID3 <a style=\"color:red\">"+r3+"</a> has already Registered for this Event");
                        }
                    else
                        {
                            out.print("RegID3 <a style=\"color:orange\">"+r3+"</a> is OK...");
                        }
                    %>
                     </p>
                     </td>
                    ...
                    <td><p><% if(i4==1)
                        {
                        out.print("RegID4 <a style=\"color:red\">"+r4+"</a> has already Registered for this Event");
                        }
                    else
                        {
                            out.print("RegID4 <a style=\"color:orange\">"+r4+"</a is OK...");
                        }
                    %>
                     </p>
                     </td>
                 ...
                 if(rs.next())
                     ...
                     if(rs.getString(1).compareTo(r22)!=0)
                         ...
                         i22=1;
                              ...
                              rs=stm.executeQuery("select Password from Erudition.authentication where RegID="+r3+";");
                 if(rs.next())
                     {
                     if(rs.getString(1).compareTo(r33)!=0)
                         {
                         msg=msg+"<br><br>Wrong Password corrosponding to RegID: "+r3+" ";
                            i33=1;
                         }
                     }
                          rs=stm.executeQuery("select Password from Erudition.authentication where RegID="+r4+";");
                 if(rs.next())
                     {
                     if(rs.getString(1).compareTo(r44)!=0)
                         {
                         msg=msg+"<br><br>Wrong Password corrosponding to RegID: "+r4+" ";
                         i44=1;
                         }
                     }
                          if(i11!=0||i22!=0||i33!=0||i44!=0)
                              throw new Exception();
                    ...
                    rs=stm.executeQuery("select Name from Erudition.main where RegID="+r3+";");
                            if(rs.next())
                                {
                                    name3=rs.getString(1);
                              }
                                  rs=stm.executeQuery("select Name from Erudition.main where RegID="+r4+";");
                                    if(rs.next())
                                    {
                                            name4=rs.getString(1);
                                    }
                                  int x=stm.executeUpdate("insert into "+eventname+"(Name1,RegID1,Name2,RegID2,Name3,RegID3,Name4,RegID4) values('"+name1+"',"+r1+",'"+name2+"',"+r2+",'"+name3+"',"+r3+",'"+name4+"',"+r4+");");
                                  if(x==1)
                            {
                            int eid=0;
                    ...
                    <td>
                     <h2>Name3</h2></td>
                     <td valign="top">
                      <span id="s5"> <% out.print(name3); %></span>
                    </td><td align="right"><a href="information.html" style=" font-size:12px">Information Security (WorkShop)</a><br />
                    <a href="nfs.html" style=" font-size:12px">NFS Most Wanted (LAN Gaming)</a><br />
                    <a href="counterstrike.html" style=" font-size:12px">Counter Strike (LAN Gaming)</a></td></tr>
                    <tr>
                    <td valign="top">
                     <h2>RegID3</h2></td>
                     <td valign="top">
                      <span> <% out.print(r3); %></span>
                    </td><td align="right"><a href="vlsi.html" style=" font-size:12px">VLSI (Leacture)</a><br />
                    <a href="ni.html" style=" font-size:12px">NI (Workshop)</a><br />
                    <a href="robowars.html" style=" font-size:12px">RoboWars (Robotics)</a></td></tr><tr>
                        <td><h2>Name4</h2></td><td valign="top">
                      <span> <% out.print(name4);%></span></td><td align="right">
		...
		else
		{
		 ...
		 %>
                ...
                <% }  }catch(Exception e){System.out.println(e);%>
                    ...
                    <a href="#" style=" font-size:12px">Conjura (Oen Hardware Exhibition)</a><br />
                    <a href="paperpresentation.html" style=" font-size:12px">Xperia (Paper Presentation)</a></td></tr>
                    <tr>
                    <td>
                     </td>
                    ...
                    <a href="counterstrike.html" style=" font-size:12px">Counter Strike (LAN Gaming)</a></td></tr>
                    <tr>
                    <td> <p>Sorry, an error has occured while connection with server<br />Please <a href="Event4.html">REGISTER</a> again after sometime</p>
                     </td>
                     <td valign="top">
